  ...
  return (
    <Card className="w-full">
      ...
      <CardBody className="px-4 py-0 grid grid-cols-12">
        <Table hideHeader aria-label="Example table with dynamic content" removeWrapper className="pb-3 pt-2 col-span-12 lg:col-span-5">
        ...
        <Table hideHeader aria-label="Example table with dynamic content" removeWrapper className="pb-3 pt-2 col-span-12 lg:col-span-6">
          <TableHeader columns={columns}>
            {(column) => (
              <TableColumn key={column.key}>{column.label}</TableColumn>
            )}
